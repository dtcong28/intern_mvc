        ...
        <form method="POST" enctype="multipart/form-data" class="col-6">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="name"
                       value="<?php echo isset($oldData->name) && !isset($_SESSION['dataInput']) ? $oldData->name : (!isset($_SESSION['errCreate']['name']) && isset($_SESSION['dataInput']) ? $_SESSION['dataInput']['name'] : '') ?>">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="email"
                       value="<?php echo isset($oldData->email) && !isset($_SESSION['dataInput']) ? $oldData->email : (!isset($_SESSION['errCreate']['email']) && isset($_SESSION['dataInput']) ? $_SESSION['dataInput']['email'] : '') ?>">
