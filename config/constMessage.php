...
define('ERROR_LOGIN_PASS', 'The password or email entered is incorrect. Forgot password?');
...
define('ERR_PASSVERIFY_INVAILD', 'Password Verify can not be blank!');
define('ERR_PASSVERIFY_CONFIRMED', 'Password verify does not match!');
